package com.jonlink.common.utils.file;
...
import com.jonlink.common.exception.file.FileNameLengthLimitExceededException;
import com.jonlink.common.exception.file.FileSizeLimitExceededException;
import com.jonlink.common.exception.file.InvalidExtensionException;
import com.jonlink.common.utils.DateUtils;
import com.jonlink.common.utils.StringUtils;
import com.jonlink.common.utils.uuid.IdUtils;
import com.jonlink.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = JonLinkConfig.getProfile();
    ...
    {
        int dirLastIndex = JonLinkConfig.getProfile().length() + 1;
